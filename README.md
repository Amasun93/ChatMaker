...
| v0.1.0-rc1 发布候选 | 已发布 | 确定性 ZIP、SHA-256、全新虚拟环境安装、贡献模板和一分钟演示通过；[GitHub 预发布可下载](https://github.com/Amasun93/ChatMaker/releases/tag/v0.1.0-rc1) |
| 不依赖 Mind+ 的环境 | 下一阶段 | 尚未实现 |

## 开发预览

当前版本为 `v0.1.0-rc1` 发布候选。Nano 编译与网页创作可以用于培训试运行；真实开发板烧录和实物效果仍需在现场单独验收。
